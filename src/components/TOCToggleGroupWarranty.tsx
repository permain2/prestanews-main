...
const tocItems: TOCItem[] = [
    { id: "cards", label: "All Providers", href: "#cards" },
    ...
    { id: "cost-breakdown", label: "Costs", href: "#cost-breakdown", hideOnMobile: true },
            ...
            <AnimatePresence initial={false}>
                {isSelected && (
                    <motion.div
                        ...
                        layoutId="toc-selected-indicator-warranty"
                    />
                )}
            </AnimatePresence>
        </motion.a>
...
export default function TOCToggleGroupWarranty() {
