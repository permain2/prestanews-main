...
import { animate, stagger, wrap, delay } from 'motion';
...
function CursorTrailDark({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "trail-images-layer", children: /* @__PURE__ */ jsx(AnimatePresence, { children: trailImages.map((image) => /* @__PURE__ */ jsx(
          motion.img,
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "dark-overlay" }),
        /* @__PURE__ */ jsxs("div", { className: "content-layer", children: [
          kicker && /* @__PURE__ */ jsx(
            motion.span,
            {
